 ...
 * Vendor Deal Analytics API
 *
 * GET /api/vendor/analytics/deals
 *
 * Authorization: VENDOR only
 *
 * Returns performance metrics for each of the vendor's deals.
 */
...
import { getVendorDealsAnalytics } from '@/lib/analytics/vendor-analytics'
...
export async function GET(request: NextRequest) {
  ...
  // Get analytics
  const result = await getVendorDealsAnalytics(
